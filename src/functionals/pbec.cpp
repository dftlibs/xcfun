...
template<class num>
static num ENERGY_FUNCTION(XC_PBEC)(const densvars<num> &d)
{
...
template<class num>
static num ENERGY_FUNCTION(XC_VWN_PBEC)(const densvars<num> &d)
{
...
NEW_GGA_FUNCTIONAL(XC_PBEC);
SHORT_DESCRIPTION(XC_PBEC) = "PBE correlation functional";
LONG_DESCRIPTION(XC_PBEC) =	     "PBE correlation functional.\n"
...
TEST_IN(XC_PBEC) = {0.39E+02, 0.38E+02, 0.81E+06, 0.82E+06,0.82E+06};
TEST_OUT(XC_PBEC) =    {-0.184442072405E+01,   
