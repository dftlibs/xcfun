...
template<class num>
static num ENERGY_FUNCTION(XC_M06X2C)(const densvars<num> &d)
{
...
NEW_TMGGA_FUNCTIONAL(XC_M06X2C);
SHORT_DESCRIPTION(XC_M06X2C) = "M06-2X Correlation";
LONG_DESCRIPTION(XC_M06X2C) =
