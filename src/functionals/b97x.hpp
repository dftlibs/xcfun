...
// Todo: Mixing in of exact exchange
namespace b97x
{
    ...
    template<class num>
    static num energy_b97x_ab(const parameter &Gamma, const parameter c_params[], const num &a_43, const num &gaa)
    {
        
        const num s2_ab = b97xc::spin_dens_gradient_ab2(gaa, a_43);
