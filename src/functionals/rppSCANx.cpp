...
template<class num>
static num rppSCANX(const densvars<num> &d)
{
  num Fx_a;
  num Fx_b;
...
FUNCTIONAL(XC_RPPSCANX) = {
  ...
  {-1.62422140833e-01, -8.63058918283e-01, -5.58294304642e-01, 
    -3.58443838214e-02, 0.00000000000e+00, -9.88320884046e-02, 
    5.70095454667e-02, 5.20592592676e-02}
};
