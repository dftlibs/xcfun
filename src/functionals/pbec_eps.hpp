...
namespace pbec_eps {
template <class num, class T> static num A(const num & eps, const T & u3) {
...
template <class num> static num pbec_eps(const densvars<num> & d) {
...
template <class num> static num pbec_eps_polarized(const num & a, const num & gaa) {
