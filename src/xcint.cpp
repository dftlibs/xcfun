...
vars_data xcint_vars[XC_NR_VARS] =
  {
    ...
    {"XC_A_B_GAA_GAB_GBB_LAPA_LAPB_TAUA_TAUB", 9, XC_DENSITY | XC_GRADIENT | XC_LAPLACIAN | XC_KINETIC},
    {"XC_A_B_GAA_GAB_GBB_LAPA_LAPB_TAUA_TAUB_JPAA_JPBB", 11, XC_DENSITY | XC_GRADIENT | XC_LAPLACIAN | XC_KINETIC | XC_JP},
    {"XC_N_S_GNN_GNS_GSS_LAPN_LAPS_TAUN_TAUS", 9, XC_DENSITY | XC_GRADIENT | XC_LAPLACIAN | XC_KINETIC},
