...
struct evaluator_table
{
  evaluator_table(void)
  {
...
template<class T, int Ndeg>
static void eval_lda_rs(const xc_functional::xc_functional_data &fun, 
			T *res, const T *d)
{
  typedef taylor<T,2,Ndeg> ttype;
  densvars<ttype> dv(&fun);
...
template<class T, int Ndeg>
static void eval_gga_rs(const xc_functional::xc_functional_data &fun, 
			T *res, const T *d)
{
  typedef taylor<T,5,Ndeg> ttype;
  densvars<ttype> dv(&fun);
...
template<class T, int Ndeg>
static void eval_mgga_ab(const xc_functional::xc_functional_data &fun, 
			 T *res, const T *d)
{
...
template<class T, int Ndeg>
static void eval_mgga_rs(const xc_functional::xc_functional_data &fun, 
			 T *res, const T *d)
{
  typedef taylor<T,7,Ndeg> ttype;
  densvars<ttype> dv(&fun);
...
evaluator xc_evaluator_lookup(int mode, int type, int order)
{
  ...
  return tab->tab[mode][type][order];
}
